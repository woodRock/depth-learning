"""Trainer for Multi-modal JEPA with SigReg."""
...
class JEPASigRegTrainer(BaseTrainer):
    """Trainer for Multi-modal JEPA with SigReg regularization."""
    
    def build_model(self, task: str = "presence") -> nn.Module:
        """Build fused JEPA + SigReg model."""
        ...
        return MultimodalJEPASigReg(
            ...
            use_decoder=False,  # Can enable for world reconstruction
            n_classes=4,
        ).to(self.device)
