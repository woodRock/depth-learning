...
def train():
    ...
    train_dataset = FishDataset(dataset_path, transform=transform, mode="train", use_augmentation=args.with_aug)
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, drop_last=True)

    val_dataset = FishDataset(dataset_path, transform=transform, mode="val", use_augmentation=False)
